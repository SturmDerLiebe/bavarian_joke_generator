-- READER:
CREATE USER IF NOT EXISTS reader IDENTIFIED BY 'amOcsWJcnsai';
...
-- SUBMITTER:
CREATE USER IF NOT EXISTS submitter IDENTIFIED BY 'zvARGGsgnstrnNSOGFNK';
...
-- AUTHENTICATOR
CREATE USER IF NOT EXISTS authenticator IDENTIFIED BY 'KJHiuHJKbBHfuWXcfVKY';
