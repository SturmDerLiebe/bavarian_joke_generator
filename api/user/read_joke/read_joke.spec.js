...
test("User searching with an existing keyword should receive a joke", async function({ request }) {
...
test(
    "User searching with a non existing keyword should receive an error response",
